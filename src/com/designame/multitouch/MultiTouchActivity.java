package com.designame.multitouch;
...
public class MultiTouchActivity extends SherlockActivity implements OnTouchListener {
		...
		if (parent instanceof ViewGroup) {
			...
			for (int i = 0; i < possibleViews.size(); i++) {
				...
				if (((view.getHeight() + location[1] >= y)
						...
						& (view.getLeft() <= x) & (view.getTop() <= y) & view.isShown())
